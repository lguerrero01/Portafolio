...
export class ProfileService {
  ...
  public projects: Proyect[] = [
    ...
    },
    {
      id: 4,
      title: 'Cuadernito',
      desc: 'App móvil tipo cuaderno de notas con cámara, adjuntos multimedia, recordatorios locales y opción de compartir, construida con Ionic + Capacitor sobre Angular 19.',
      category: 'Mobile',
    ...
    },
    {
      id: 5,
      title: 'MovieLearning',
      desc: 'Plataforma de aprendizaje basada en contenido audiovisual, con frontend en Angular y API propia desarrollada tanto en Node/Express como en Laravel.',
      category: 'Full Stack',
      techs: ['Angular', 'Node.js', 'Express', 'Laravel'],
      imgUrl: 'assets/img/projects/movielearning/courses-relevantie.jpg',
      gallery: [
        'assets/img/projects/movielearning/courses-relevantie.jpg',
        'assets/img/projects/movielearning/group-7.jpg',
        'assets/img/projects/movielearning/screenshot-1.jpg',
        'assets/img/projects/movielearning/screenshot-2.jpg',
        'assets/img/projects/movielearning/screenshot-4.jpg',
        'assets/img/projects/movielearning/screenshot-3.jpg',
      ],
      livedemo: '',
      githurl: '',
      featured: true,
    ...
    },
    {
      ...
      desc: 'Juego de cartas móvil interactivo desarrollado con Ionic y Angular, con almacenamiento local en el dispositivo.',
      category: 'Mobile',
